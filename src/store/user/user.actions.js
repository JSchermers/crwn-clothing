...
export const checUserSession = () => createAction(USER_ACTION_TYPES.CHECK_USER_SESSION);
...
export const signUpSuccess = (user, additionalDetails) => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCES, { user, additionalDetails});
...
export const signOutSuccess = () => createAction(USER_ACTION_TYPES.SIGN_OUT_SUCCES)
